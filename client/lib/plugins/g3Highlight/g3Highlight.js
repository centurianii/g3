   ...
   prototype: {
      ...
      build: function(){
         ...
         if(this.defaults.language == 'unformatted'){
            ...
            this.instance.nodes = []; // we don't need this as it consumes memory of removed nodes
            return result;
         }
      ...
      unFormat: function(node){
         ...
         switch(self.defaults.library){
            ...
            case 'prism':
               ...
               break;
            case 'prettify':
               $n.attr('class', g3.utils.clearString($n.attr('class'), ' ', 'language-\\w', 'full', 'linenums', 'prettyprint', 'prettyprinted'));
               $n.html(text);
               break;
            // add yours!
         }
